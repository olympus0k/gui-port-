...
L11 = Label(gui, text = "go olypus",  font=("Helvetica", 16, 'underline'))
L11.place(x = 16, y = 10)
 
L21 = Label(gui, text = "host to scan: ")
L21.place(x = 180, y = 120)
 
L22 = Entry(gui, text = "")
L22.place(x = 280, y = 120)
L22.insert(0, "")
...
L24 = Entry(gui, text = "80")
L24.place(x = 180, y = 158, width = 95)
L24.insert(0, "80")
 
L25 = Entry(gui, text = "443")
L25.place(x = 290, y = 158, width = 95)
L25.insert(0, "443")
 
L26 = Label(gui, text = "scaned: ")
